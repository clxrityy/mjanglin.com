...
export default async function Page() {
    ...
    return (
        <div className="h-full overflow-y-scroll scroll-smooth mx-auto relative">
            <div className="flex flex-col items-center justify-center gap-10 lg:gap-12 xl:gap-16 mt-96 sm:mt-80 md:mt-72 lg:mt-0 xl:-mt-20 h-full">
