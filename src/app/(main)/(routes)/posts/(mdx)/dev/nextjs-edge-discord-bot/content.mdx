...
- Data is stored with [Vercel Postgres](https://vercel.com/docs/storage/vercel-postgres).
...
- See [Nextjs Prisma Postgres](https://vercel.com/guides/nextjs-prisma-postgres) for more information on setting up Prisma with Vercel Postgres.
