...
const bigButtonVariants = cva(
    "inline-flex items-center justify-center font-semibold px-10 py-6 rounded-lg text-xl hover:scale-95 transition-all focus:ring focus:outline-none focus:ring-offset-2 focus:ring-white disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                default: "bg-[#8884d8]/70 text-zinc-50 hover:bg-zinc-900/90",
