        ...
        <div className="w-full h-full flex items-center justify-center">
            <div className="max-w-xl flex items-center justify-center mx-auto">
                <div className="w-full h-full">
                    <Button className={`hover:border-[#7289DA] border-2 border-white/50 cursor-pointer w-full h-full px-10 py-3 focus:ring-[#7289DA] focus:ring bg-transparent hover:scale-90 transition-transform`}>
