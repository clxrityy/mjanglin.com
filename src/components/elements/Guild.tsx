...
export default async function Guild(guildData: GuildData) {
    ...
    return <Link href={`/guilds/${guildData.guildId}`} className="hover:scale-95 transition-all shadow-md border p-4 rounded-md border-blue-400 hover:border-blue-600 hover:shadow-lg bg-blue-400/10 hover:bg-blue-400/25">
