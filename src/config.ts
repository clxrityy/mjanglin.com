...
export const projects: Project[] = [
	...
	},
	{
		...
		slug: "https://github.com/clxrityy/bonds",
		publishedAt: "2026-05-03",
		mainImage: r2AssetPath("assets/bonds-v017.png"),
		preview:
	...
	{
		title: "CrateLoot - Minecraft Plugin",
		slug: "dev/crateloot",
		publishedAt: "2026-08-26",
		mainImage: r2AssetPath("assets/crateloot.png"),
		preview:
			"A Minecraft plugin that allows servers to create and manage loot crates with customizable rewards and possibilities.\n1.19.2 - 26.2",
		keywords: [
			"minecraft",
			"plugin",
			"loot crates",
